...
Our methodology systematically integrates data collection, data processing, analysis, pattern mining, modeling, and recommendations to create a comprehensive Visual Analytics solution for improving teaching strategies and course designs at NorthClass Institute.
...
-   Score distribution and performance metrics (for Tasks 1 & 4): 
    -   Histogram for score distribution, bar plot for accuracy rate, ridgeline plot for Performance Metrics
...
-   Determine Association and Relationship between Variables (for Task 3 & 4):
