...
This is meant to address issues #2, #3, #4, #6 & #7, by employing 1 of the following options in the DataViz makeover: (a) facet_grid or facet_wrap (b) Coordinated Multiple Views with ggiraph (c) Interactive Box plot with ggplotly()
